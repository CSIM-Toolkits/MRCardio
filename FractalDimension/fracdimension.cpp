...
double fracdimension::GetMinkowskiDimension(){
    ...
    IteratorType iterator(radius,edge,edge->GetLargestPossibleRegion());
    ...
    for(iterator.GoToBegin(); !iterator.IsAtEnd(); ++iterator){
        ...
        cont_A = cont_A + cont_elem;
    }
    dim = 2 - (log(cont_A)/log(2));
