...
int DoIt( int argc, char * argv[], T )
{
    ...
    ImageType::Pointer imagOutput = ImageType::New();
    segment seg;
    bool up = false;
    bool down = false;
    bool left = false;
    ...
    if(axis == "Eixo Curto"){
        ...
        seg.MyocardiumEC(first,last,sigma,sigma_min,sigma_max,propagation,
            curvature,advection,rms,iterations,timestep,it,conductance,alpha,
    ...
    if(axis == "Eixo Longo Vertical"){
        ...
        seg.MyocardiumELV(first,last,sigma,sigma_min,sigma_max,propagation,curvature,
